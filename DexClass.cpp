...
bool dexReadAndVerifyClassDataHeader( u1** pData, const u1* pLimit,
 ...
 * are valid. */
bool dexReadAndVerifyClassDataField( u1** pData, const u1* pLimit,
 ...
 * are valid. */
bool dexReadAndVerifyClassDataMethod( u1** pData, const u1* pLimit,
