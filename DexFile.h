...
DEX_INLINE DexTypeId* dexGetTypeId(const DexFile* pDexFile, u4 idx) {
 ...
 */
DEX_INLINE DexTypeList* dexGetProtoParameters(
...
DEX_INLINE DexClassDef* dexGetClassDef(const DexFile* pDexFile, u4 idx) {
...
DEX_INLINE DexTypeList* dexGetInterfacesList(const DexFile* pDexFile,
    const DexClassDef* pClassDef)
{
...
DEX_INLINE DexAnnotationsDirectoryItem* dexGetAnnotationsDirectoryItem(
    const DexFile* pDexFile, const DexClassDef* pClassDef)
{
    if (pClassDef->annotationsOff == 0)
        return NULL;
    return (DexAnnotationsDirectoryItem*)
...
DEX_INLINE u1* dexGetClassData(const DexFile* pDexFile,
    const DexClassDef* pClassDef)
{
...
DEX_INLINE DexAnnotationSetItem* dexGetAnnotationSetItem(
    const DexFile* pDexFile, u4 offset)
{
    if (offset == 0) {
        return NULL;
    }
    return (DexAnnotationSetItem*) (pDexFile->baseAddr + offset);
}
/* get the class' annotation set */
DEX_INLINE DexAnnotationSetItem* dexGetClassAnnotationSet(
...
DEX_INLINE DexFieldAnnotationsItem* dexGetFieldAnnotations(
    const DexFile* pDexFile, const DexAnnotationsDirectoryItem* pAnnoDir)
{
    (void) pDexFile;
    ...
    return ( DexFieldAnnotationsItem*) &pAnnoDir[1];
}
...
DEX_INLINE DexMethodAnnotationsItem* dexGetMethodAnnotations(
    const DexFile* pDexFile, const DexAnnotationsDirectoryItem* pAnnoDir)
{
    (void) pDexFile;
    ...
    return (DexMethodAnnotationsItem*) addr;
}
...
DEX_INLINE DexParameterAnnotationsItem* dexGetParameterAnnotations(
    const DexFile* pDexFile, const DexAnnotationsDirectoryItem* pAnnoDir)
{
    (void) pDexFile;
    ...
    return (DexParameterAnnotationsItem*) addr;
}
...
DEX_INLINE DexAnnotationSetRefList* dexGetParameterAnnotationSetRefList(
    const DexFile* pDexFile, const DexParameterAnnotationsItem* pItem)
{
    if (pItem->annotationsOff == 0) {
        return NULL;
    }
    return (DexAnnotationSetRefList*) (pDexFile->baseAddr + pItem->annotationsOff);
}
